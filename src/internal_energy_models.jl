...
# generate array of energies for the cut-off harmonic oscillator model
...
# generate array of energies for the cut-off anharmonic oscillator model
...
# compute vibrational partition function using an array of vibrational energies
function Z_vibr(T, E_vibr_array_K)
    return sum(exp.(-E_vibr_array_K ./ T))
end

# average vibrational spectrum
...
# compute non-scaled vibrational energy using an array of vibrational energies, J/kg
...
# compute non-scaled vibrational specific heat using an array of vibrational energies, J/kg/K
